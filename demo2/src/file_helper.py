...
def search_asset_by_technical_specs_returns_empty_list():
    items = [{
            "id": 2,
...
def search_asset_by_technical_specs_returns_nonempty_list():
    items = [{
            "id": 2,
            "serial_no": "C02ZL5NRMD6Q",
            "asset_type": "Computer",
...
def search_asset_by_status_pendingreturn_returns_empty_list():
    items = []
...
def search_asset_by_status_none_returns_all():
    items = [{
                "id": 2,
                "serial_no": "C02ZL5NRMD6Q",
                "asset_type": "Computer",
...
def search_asset_by_status_pendingreturn():
    items = [
            {
                "id": 2,
                "serial_no": "C02ZL5NRMD6Q",
